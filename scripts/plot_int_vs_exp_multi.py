...
datadir  = [
    '/my/path/to/output/files/amp_cut1/',
    '/my/path/to/output/files/amp_cut2/',
    '/my/path/to/output/files/amp_cut3/',
    ]
savedir  = '/my/path/to/plots/'
...
figoutfile = "luneburg_int_vs_exp_multilyr_multiexp_%irays_grid_multiampcut.pdf"%(nrays)
...
for i in range(len(layers)):
    ...
    infile_list = [('luneburg_out_%i_%.2f_%i_grid.dat'%(layers[i],exp,nrays)).replace('_0.','_0d') for exp in plaw_exp]
