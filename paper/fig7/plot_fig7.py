...
infile = ('luneburg_enc_int_%i_%.2f_%i_grid.dat'%(layers,plaw_exp,nrays)).replace('_0.','_0d')
...
pl.gca().set_color_cycle(['k','g','r','c','y','m','k','#FF8000','brown'])
...
### add legend
legend = pl.legend(([r"$%.2f$"%plaw_exp]),frameon=False,loc='upper left',handlelength=1.5,title="$\mathrm{power}$-$\mathrm{law}$ \n $\mathrm{exponent}$")
